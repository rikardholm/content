...
public class SpringRestTemplateProviderTest extends AbstractHttpProvisioningTest {
    ...
    protected TemplateProvider<String> createStringProvider(String serverConnection, String rootPath) {
        return new SpringRestTemplateProvider<>(serverConnection, rootPath + "/", String.class);
    }

    @Override
    protected TemplateProvider<byte[]> createByteArrayProvider(String serverConnection, String rootPath) {
        return new SpringRestTemplateProvider<>(serverConnection, rootPath + "/", byte[].class);
    }
}